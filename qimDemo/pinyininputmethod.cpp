...
CPinyinInputMethod::CPinyinInputMethod()
{
    ...
    //windows
    //QSettings setter("C:/Users/yalezy/Desktop/123/qimDemo/dict/pinyinEx.ini", QSettings::IniFormat);
    ...
    bool ret = im_open_decoder("C:/Users/yalezy/Desktop/123/qimDemo/dict/dict_pinyin.dat", "./dict/user.dat");
    if (!ret)
    {
